...
MainTab:CreateButton({
    Name = "📅 Claim Daily Reward (per day)",
    Callback = function()
...
MainTab:CreateButton({
    ...
    Callback = function()
        ...
        Rayfield:Notify({Title = "Anti-AFK ON", Content = "Work infinite", Duration = 4})
    end,
})

Rayfield:Notify({
    Title = "Hack loaded ✓",
    Content = "Thanks for using by Data join discord",
    Duration = 10,
    Image = 4483362458
})
